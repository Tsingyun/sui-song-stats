...
print(f"  - 月度排行榜: {len(output_data['monthly_leaderboard'])} 个月")
print(f"  - 季度排行榜: {len(output_data['quarterly_leaderboard'])} 个季度")
print(f"  - 年度排行榜: {len(output_data['yearly_leaderboard'])} 个年度")
